...
закрепить материал прошедших лекций: ООП;

паттерн DAO/Repository; MongoDB/Embedded MongoDB;

работа с БД через Spring Data MongoDB;

организация данных в MongoDB и решение типовых проблем; интеграционное тестирование репозиториев с помощью @DataMongoTest.
